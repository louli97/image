...
(function ($) {
    ...
    $(document).on('click', '.setting_tool .c ul li', function (e) {
        ...
        if(_let.lis.is('.sepia')){
            ...
            localStorage.adams_font_style = "body{background-image: url(https://s2.ax1x.com/2020/02/06/1yLVcd.jpg);background-size: 100% 100%;background-repeat: no-repeat;background-attachment: fixed;}";
        } else {
